...
2024-12-04 14:32:45.682 [main] INFO  Application - Responding at http://0.0.0.0:6011
```
...
```
cd existing_repo
git remote add origin https://git.sch.bme.hu/kszk/devteam/szobatarsch/szobatarsch-backend.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.sch.bme.hu/kszk/devteam/szobatarsch/szobatarsch-backend/-/settings/integrations)
